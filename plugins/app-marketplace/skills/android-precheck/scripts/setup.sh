#!/usr/bin/env bash
# Android Precheck Skill — Automated Setup
...
echo ""
echo -e "${BOLD}Android Precheck Skill — Dependency Setup${NC}"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
...
if [ -f "$SCRIPT_DIR/scripts/precheck-android.sh" ]; then
    echo -e "${GREEN}✓${NC} found"
    ((passed++))

    # Ensure executable
    if [ ! -x "$SCRIPT_DIR/scripts/precheck-android.sh" ]; then
        chmod +x "$SCRIPT_DIR/scripts/precheck-android.sh"
        echo -e "    Made executable"
    fi
else
    echo -e "${RED}✗ not found${NC}"
    echo -e "    Expected at: $SCRIPT_DIR/scripts/precheck-android.sh"
    ((failed++))
